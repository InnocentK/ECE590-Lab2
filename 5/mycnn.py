...
# Based off of LeNet-5 and ResNet
...
# Testset uses the same dataset loader but with some slight alterations.
...
for i in range(start_epoch, EPOCHS):
    ...
    if i % DECAY_EPOCHS == 0 and i != 0:
        current_learning_rate = INITIAL_LR * (DECAY**(EPOCHS // DECAY_EPOCHS))
...
# Code used to generate the labels for CIFAR100. set loadTest to True when you want the labels made and false when you do not want labels
loadTest = True
if loadTest == True:
